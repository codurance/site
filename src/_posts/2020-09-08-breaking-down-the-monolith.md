...
image:
  src: /assets/custom/img/blog/2020-09-08-breaking-down-the-monolith/breaking_down_the_monolith_5.jpg
tags:
...
This, I believe came as a reaction to large numbers of software development teams wanting to adopt a MicroServices architecture even though their current architecture was akin to the “Big Ball Of Mud” architecture. Simon’s point is that MicroServices are not a “silver bullet” and you cannot shortcut applying good structure and design to your codebases. Furthermore, MicroServices architectures do not eliminate complexity. Instead, they shift that complexity from an application codebase level to infrastructure and co-ordination - in particular deployments, monitoring, observability and testing. These are often areas that tend to be less well understood in Organisations looking to adopt MicroServices for the first time. Martin Fowler talks about this in one of his articles, where he uses the term “Microservices Premium” - https://martinfowler.com/bliki/MicroservicePremium.html .
...
Introducing Bounded Conexts to the Monolith
