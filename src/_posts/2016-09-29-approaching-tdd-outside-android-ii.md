...
Following the acceptance criteria, <a href="/2016/09/28/approaching-tdd-outside-android/#acceptance-criteria">defined in the previous post</a>, we have to make two deposits and one withdrawal. Notice that withdrawals are transactions with negative amounts.
...
<img src="{{ site.baseurl }}/assets/custom/img/blog/acc2.png" alt="Outside-in acceptance test coverage" class="img-fluid"/>
