...
### [Running Serverless: Introduction to AWS Lambda and the Serverless Application](https://leanpub.com/running-serverless?utm_source=newsletter&utm_medium=email&utm_campaign=feb2020)
