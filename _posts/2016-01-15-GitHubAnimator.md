...
There are still a few things hardcoded on the F# code, so it's not a "consumer" ready product, but some developers might be able to use it as it is. You can find the code [here](https://github.com/pedromsantos/GitHubAnimator).
