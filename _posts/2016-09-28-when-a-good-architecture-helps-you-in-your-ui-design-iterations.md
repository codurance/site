...
## Make it work
So as I explain, originally my main objective had been to make it work. And I did. With my big refactoring in place, I finished my goals for the app in no time, having the big features working. The app looked like this at that time:
...
We still have some functionality that we want to add to the app, but I think that the design is largely done. Another thing that I felt was that I didn't want to "kill the designer" when Giulia appeared with new ideas that would make me change all of the design. It was really simple to adopt and painless. And that's a thing that it's good to have.
