...
15. The output shows the "shrinking process" from the sixth input original value ```[-3; 1; 5; -3; 6; 2; 6; -2]``` to the  "shrunk" input ```[1; 0]``` that still falsifies the property 
